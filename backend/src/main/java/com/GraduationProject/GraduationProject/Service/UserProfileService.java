 ...
 *
 * Responsibilities include: - Fetching user profile information (ProfileDTO) -
 * Editing user profile information - Validating input for textual and numeric
 * fields
 */
@Service
public class UserProfileService {
     ...
     *
     * Profile includes: - Basic user info (name, bio, photo) - Role-specific
     * info (Vet or Clinic) - Pets owned by the user - Services offered by the
     * user (if any)
     *
     ...
     *
     * Editable fields include: - firstName, lastName, bio, photoUrl - Vet
     * specialty (if role is VET) - Clinic info (latitude, longitude, city,
     * address) if role is CLINIC
     *
