    ...
    return (
        ...
        <textarea
            ...
            className="w-full min-h-[100px] rounded-xl p-4 bg-white/10 text-white placeholder-white/50 outline-none resize-none mb-5"
        />

        {/* SUBMIT */}
        <button
            onClick={handleSubmit}
            disabled={!selectedPet || !city || createAdoptionPost.isLoading}
